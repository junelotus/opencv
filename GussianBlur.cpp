...
{
       // void *src_copy_addr =/*static_cast<char*>*/ (src_copy+(i+middle)*3*(cols_src+middle*2)+middle);
       // void *src_addr =/*static_cast<char*>*/(src+i*cols_src*3);
//memcpy(src_copy_addr,src_addr,cols_src*3);
src_copy.at<Vec3b>(i+middle,j+middle)[0] = src.at<Vec3b>(i,j)[0];
src_copy.at<Vec3b>(i+middle,j+middle)[1] = src.at<Vec3b>(i,j)[1];
src_copy.at<Vec3b>(i+middle,j+middle)[2] = src.at<Vec3b>(i,j)[2];
...
int main()
{
         ...
         Mat src =imread("/home/june/opencv_test/blur.jpg");
         imshow("dog",src);
